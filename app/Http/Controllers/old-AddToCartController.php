...

{
    ...
    public function addToCart(Request $request){
       ...
       $shop_data = User::where('name', $request['shop_domain'])->firstOrFail();
        ...
        //echo '<pre>';print_r($shop_base_url);exit;
        $diamond_product_id = "";
        ...
        if($request['diamond_id']){
            ...
            try{
                ...
                //$secondDiamondData = $this->getDiamondById($request['dealer_id'],$request['second_diamond_id'],$request['is_lab']);
        ...
        if($request['second_diamond_id'] ){
            ...
            try{
               ...
               //echo'test';print_r($secondDiamondData);exit;
                ...
                if($in_shopify == "1"){
                    ...
                    $products_array = array(
                        ...
                        "product" => array(
                            ...
                            "variants"          => array(array("id" => $variantId,"price" => number_format($secondDiamondData['diamondData']['fltPrice']))),
                    ...
                    $products_array = array(
                        ...
                        "product" => array(
                            ...
                            "title"             => $secondDiamondData['diamondData']['mainHeader'],

                            "body_html"         => $secondDiamondData['diamondData']['subHeader'],
                            ...
                            "variants"          => array(array("sku" => $request->diamond_id,"price" => number_format($secondDiamondData['diamondData']['fltPrice']))),
                    ...
                    $image_array = array("image" => array("attachment" => base64_encode(file_get_contents($secondDiamondData['diamondData']['image2']))));
            ...
            try{
               ...
               //exit;
                ...
                if($in_ring_shopify == "1"){
                    ...
                    //echo "<pre>";print_r($finalProductDataRIng);exit;
        ...
        if($diamond_product_id && $setting_product_id && $second_diamond_product_id){
            ...
            //echo '<pre>';print_r('setting and diamond URL'. $checkout_url);exit;
        ...
        if($diamond_product_id){
            ...
            //echo '<pre>';print_r('diamondURL'. $checkout_url);exit;
        ...
        if($setting_product_id){
            ...
            //echo '<pre>';print_r('settingURL'. $checkout_url);exit;
 ...
 //        return $pdf->download('Diamond.pdf',$headers);
    ...
    function printDiamond($shop_domain,$diamond_id,$second_diamond_id) {

        // header('Access-Control-Allow-Origin: *');

        // header('Access-Control-Allow-Methods: GET, PUT, POST, DELETE, OPTIONS');

        $getDiamondData = self::getDiamondByIdForPdf($shop_domain,$diamond_id,$second_diamond_id);
    ...
    public static function getDiamondByIdForPdf($shop,$diamondId,$secondDiamondId){
        ...
        if($getData['0']['diamondId'] != "" && $getData['0']['diamondId'] > 0 && $getData['1']['diamondId'] != "" && $getData['1']['diamondId'] > 0){
            ...
            $secondDiamondData = (array) $getData[1];

            $returnData = ['diamondData' => $diamondData ,'secondDiamondData' => $secondDiamondData];

        } else {

            $returnData = ['diamondData' => [] ,'secondDiamondData' => []];
    ...
    //Print For Diamond And Ring
     ...
     function printRingDiamond($shop_domain,$diamond_id,$second_diamond_id) {

        // header('Access-Control-Allow-Origin: *');

        // header('Access-Control-Allow-Methods: GET, PUT, POST, DELETE, OPTIONS');

        $getDiamondData = self::getRingDiamondByIdForPdf($shop_domain,$diamond_id,$second_diamond_id);

        view()->share('diamond',$getDiamondData);

        $pdf = PDF::loadView('completeRingPrintpdf', $getDiamondData);
