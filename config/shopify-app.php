...
return [
    ...
    */
    ...
    'api_scopes' => env(
        'SHOPIFY_API_SCOPES',
        'read_inventory,write_inventory,read_products,read_themes,write_themes,
        write_products',
    ),
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'webhooks' => [
        ...
        //     'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS',  env('APP_URL') . 'api/appUninstallJob',),
        // ],
        // [
        //     'topic' => env('SHOPIFY_WEBHOOK_2_TOPIC', 'shop/update'),
        //     'address' => env('SHOPIFY_WEBHOOK_2_ADDRESS',  env('APP_URL') . 'api/appShopUpdateJob',),
        // ],
    ],
    ...
    */
    ...
    'scripttags' => [
        // [
        //     'src' => env('SHOPIFY_SCRIPTTAG_1_SRC', 'https://app.studbuilder.com/widgets/static/js/bundle.js'),
        ...
        // // ],
        // [
        //     'src' => env('SHOPIFY_SCRIPTTAG_2_SRC', 'https://app.studbuilder.com/customCssFront/customFrontCss.js'),
