...
const DiamondtoolSetting = (props) => {
  ...
  const getDiamondProductsData = async () => {
    ...
    console.log("getCaratmax");
    console.log(getCaratmin);
    console.log(getCaratmax);

    console.log(minCarat);
    console.log(maxCarat);
  ...
  }, [gettabname, getminedsetting, getlabsetting]);
        ...
        <>
         ...
         .noUi-horizontal .noUi-tooltip{
          ...
          .noUi-horizontal .noUi-tooltip::after{
           border-color: ${window.initData.data[0].button_colour} transparent transparent transparent
          }
