  ...
  <body>
    ...
    <section class="diamonds-search with-specification diamond-page">
        ...
        <div class="personal-training-heading" style="background-color:#e8e8e8; color: #000; width: 100%; display: block; height: 100px; vertical-align: middle;"  >
         ...
         <div style="width: 10%; float: left; padding: 5px; ">
            ...
            <img
                ...
                src="<?php echo $diamond['diamondData']['certificateIconUrl1'] ? $diamond['diamondData']['certificateIconUrl1'] : ''; ?>"
          ...
          <div style="width: 80%; float: left;">
             ...
             <p style=" text-align: left; padding-top: 18px; padding-left: 15px;"><?php echo $diamond['diamondData']['subHeader'] ? $diamond['diamondData']['subHeader'] : ''; ?>
      ...
      <div class="personal-training-heading" style="background-color:#1979c3; color: #fff; width: 100%; display: block;  height: 100px; vertical-align: middle;">
        ...
        <h2 style="text-align: left;"><?php echo $diamond['diamondData']['mainHeader'] ? $diamond['diamondData']['mainHeader'] : ''; ?></h2>

        <p> <?php echo $diamond['diamondData']['subHeader'] ? $diamond['diamondData']['subHeader'] : '' ; ?> </p>
      ...
      <div class="personal-training">
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <?php if(isset($diamond['diamondData']['fltPrice1'])) { ?>
              ...
              <tr>
                ...
                <td><?php 
                    ...
                    if($diamond['diamondData']['currencyFrom'] == 'USD'){
                        ...
                        echo "$".number_format(str_replace(',', '', $diamond['diamondData']['costperCarat1']));    

                     }else{

                        echo $diamond['diamondData']['currencyFrom'].$diamond['diamondData']['currencySymbol'].number_format(str_replace(',', '', $diamond['diamondData']['costperCarat1'])); 
            ...
            <?php if(isset($diamond['diamondData']['size1'])) { ?>

              <tr>

                <td><b><?php echo 'Carat Weight'; ?></b></td>

                <td><?php echo $diamond['diamondData']['size1'] ? $diamond['diamondData']['size1'] : 'NA' ?></td>
        ...
        <div class="personal-training-heading" style="background-color:#e8e8e8; color: #000; width: 100%; display: block; height: 100px; vertical-align: middle;"  >
         ...
         <div style="width: 10%; float: left; padding: 5px; ">
            ...
            <img
                ...
                src="<?php echo $diamond['diamondData']['certificateIconUrl2'] ? $diamond['diamondData']['certificateIconUrl2'] : '' ; ?>"
      ...
      <div class="personal-training">
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <?php if(isset($diamond['diamondData']['diamondID2'])) { ?>

              <tr>

                <td><b><?php echo 'Stock Number'; ?></b></td>

                <td><?php echo $diamond['diamondData']['diamondID2'] ?></td>

              </tr>

            <?php } ?>

            <?php if(isset($diamond['diamondData']['fltPrice2'])) { ?>
              ...
              <tr>
                ...
                <td><?php 
                    ...
                    if($diamond['diamondData']['currencyFrom'] == 'USD'){
                        ...
                        echo "$".number_format(str_replace(',', '', $diamond['diamondData']['costperCarat2']));    

                     }else{

                        echo $diamond['diamondData']['currencyFrom'].$diamond['diamondData']['currencySymbol'].number_format(str_replace(',', '', $diamond['diamondData']['costperCarat2'])); 
